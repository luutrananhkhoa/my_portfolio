...
const Aboutfooter = () => {
    ...
    return(
        <>
        {
          items.map((val, indx) => {
              return(
                <div className="p-1 w-fit relative mt-4" key={indx}>
                  <h1 className="gap-2 text-xl font-poppins text-primary-text font-bold relative flex icon_underline max-sm:text-2xl">{val.icon}{val.name}</h1>
