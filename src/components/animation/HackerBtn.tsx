...
const HackerBtn = ({ label }: { label: string }) => {
  ...
  return (
    <Button size={'lg'} className='text-base px-5 py-6 text-primary-text border border-primary hover:border hover:border-primary-text' onMouseEnter={startScrambling}>   
